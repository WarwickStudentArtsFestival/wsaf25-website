  ...
  return (
    <section className="px-8 mb-4">
      ...
      <div className="flex gap-4 justify-center text-left text-sm">
        <Link
          href="/perform"
          className="border border-slate-300 rounded-md overflow-hidden max-w-96 hover:scale-105 transition duration-75 ease-in-out"
        >
          <Image
            src={Performers}
            alt="Performing at WSAF 2024"
          ...
          <div className="p-4">
            ...
            <p className="mb-2">
              An arts festival could not take place without art! We&apos;re
              looking for your performances, creations and talents.
            </p>
            <p>
        ...
        >
          <Image
            src={Crew}
            alt="WSAF 2024 crew debrief"
            className="object-contain"
          />
          <div className="p-4">
            <h3 className="text-teal text-xl font-semibold">Crew</h3>
            <p className="mb-2">
              WSAF is a fully student-led event, made by students for students.
              We need your help to make this possible!
            </p>
            <p>
              Join us in teams such as tech, stewarding, marketing and venue
              design which can match your commitment and availability.
            </p>
        ...
        >
          <Image
            src={Guests}
            alt="WSAF 2024 art gallery"
            className="object-contain"
          />
          <div className="p-4">
            <h3 className="text-teal text-xl font-semibold">Guests</h3>
            <p className="mb-2">
              Don&apos;t want to perform or help out? You can still come on the
              day!
            </p>
            <p>
              More information about what&apos;s on will be provided closer to
              the festival. In the meantime, follow us on{' '}
              <a
                href="https://www.instagram.com/wsaf25/"
                target="_blank"
                className="text-teal"
